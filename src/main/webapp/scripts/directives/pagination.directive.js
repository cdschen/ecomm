    ...
    return {
        ...
        '<nav class="page-list">' +
            ...
            '<div class="page-total" ng-show="conf.totalItems > 0">' +
                ...
                '每页<select ng-model="conf.itemsPerPage" ng-options="option for option in conf.perPageOptions " ng-change="changeItemsPerPage()"></select>/共<strong>{{ conf.totalItems }}</strong>条' +
            '</div>' +
